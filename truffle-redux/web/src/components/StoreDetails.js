...
class StoreDetails extends React.Component {
	...
	componentDidUpdate(prevProps) {
        ...
        // }
				return { storeAddress: this.props.contract.storeAddress, store: {
          storeAddress: this.props.contract.store.owner,
          purchaseCount: JSON.stringify(this.props.contract.store.purchaseCount),
          productCount:
          JSON.stringify(this.props.contract.store.productCount),
          hash:
          this.props.contract.store.hash
        }};
			});
	...
	render() {
		...
		return (
			<div className="store-details">
				...
				<div>Store Owner: {JSON.stringify(this.state.store.owner)}</div>
